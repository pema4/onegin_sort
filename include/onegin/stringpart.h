 ...
 * 
 * Punctuation, numbers and other symbols are ignored and not used in comparison.
 * 
...
/**
 * @brief Compares letters in two parts in alphabetical order starting from the end.
 * 
 * Punctuation, numbers and other symbols are ignored and not used in comparison.
 * 
 * @param [in] first  First ::StringPart to be compared.
